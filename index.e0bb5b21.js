...
})({"2l5Lh":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "9eadfc61e0bb5b21";
...
},{}],"2AbyH":[function(require,module,exports) {
(()=>{
    const refs = {
...
function validation(form) {
    ...
    for (const input1 of allInputs){
        removeError(input1);
        if (input1.dataset.minLength) {
            if (input1.value.length < input1.dataset.minLength) {
                removeError(input1);
                createError(input1, `Min. length: ${input1.dataset.minLength}`);
                result = false;
            }
        }
        if (input1.dataset.maxLength) {
            if (input1.value.length > input1.dataset.maxLength) {
                removeError(input1);
                createError(input1, `Max. length: ${input1.dataset.maxLength}`);
                result = false;
            }
        }
        if (input1.dataset.required == "true") {
            if (input1.value == "") {
                removeError(input1);
                createError(input1, "Field is empty!");
                result = false;
            }
        }
    }
...
document.getElementById("comment__form").addEventListener("submit", function(event) {
    ...
    if (validation(this) === true) {
        ...
        document.getElementById("comment__form").addEventListener("submit", function(e) {
            e.preventDefault();
            ...
            axios.post(URI_API, {
                ...
                console.log("The end");
                refsThanks.openModalBtn.removeEventListener("click", toggleModalThanks);
                document.querySelector("[data-backdrop-review]").classList.toggle("is-hidden-review");
            });
        });
    }
}); // (() => {
...
},{}]},["2l5Lh","2AbyH"], "2AbyH", "parcelRequired7c6")

//# sourceMappingURL=index.e0bb5b21.js.map
