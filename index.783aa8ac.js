...
})({"fmARL":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "07c24174783aa8ac";
...
},{}],"449Te":[function(require,module,exports) {
(()=>{
    const refs = {
...
function validation(form) {
    ...
    for (const input1 of allInputs){
        ...
        if (input1.dataset.required == "true") {
            if (input1.value == "") {
                removeError(input1);
                createError(input1, "\u041F\u043E\u043B\u0435 \u043D\u0435 \u0437\u0430\u043F\u043E\u043B\u043D\u0435\u043D\u043E!");
                result = false;
            }
        }
    }
    ...
    if (validation(this) === true) {
        ...
        document.getElementById("form_buy-now").addEventListener("submit", function(e) {
            ...
            axios.post(URI_API, {
                ...
                console.log("The end");
                refsDiscount.openModalBtn.removeEventListener("click", toggleModal);
...
},{}]},["fmARL","449Te"], "449Te", "parcelRequired7c6")

//# sourceMappingURL=index.783aa8ac.js.map
