...
})({"dUcm9":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "0d9b363ac1437ac3";
...
selectBtns.forEach((btn)=>{
    btn.addEventListener("click", ()=>btn.parentNode.classList.toggle("buy-selected__card"));
});
//? Submenu Func
...
let likesCounter = Math.round(Math.random() * 1099 + 1);
heartBtns.forEach((heartBtn)=>{
    heartBtn.addEventListener("click", ()=>{
        ...
        return heartBtn.firstElementChild.classList.toggle("submenu-selected__icon");
    });
});

},{}]},["dUcm9","8nBRx"], "8nBRx", "parcelRequired7c6")

//# sourceMappingURL=index.c1437ac3.js.map
